...
class LandlordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create landlord" do
    assert_difference('Landlord.count') do
      post landlords_url, params: { landlord: { birth_date: @landlord.birth_date, name: @landlord.name } }
    end
  ...
  test "should update landlord" do
    patch landlord_url(@landlord), params: { landlord: { birth_date: @landlord.birth_date, name: @landlord.name } }
